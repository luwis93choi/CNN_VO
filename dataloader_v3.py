...
class KITTI_Dataset_gray_full_sequence(torch.utils.data.Dataset):

    def __init__(self, name='',
                       img_dataset_path='', pose_dataset_path='', 
                       train_transform=None,  
                       valid_transform=None,  
                       sequence=['00'], verbose=0, mode='training'):
        ...
        self.training_data_list, self.validation_data_list = train_test_split(self.data_list, test_size=0.33, random_state=42)
        ###################################
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'training':
            current_data_row = self.training_data_list[index]

        elif self.mode == 'validation':
            current_data_row = self.validation_data_list[index]
    ...
    def __len__(self):
        ...
        if self.mode == 'training':
            ...
            return len(self.validation_data_list)
